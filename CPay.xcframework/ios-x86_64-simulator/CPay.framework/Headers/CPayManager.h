...
/**
 * Setup your merchant token from CITCON
 *
 * @param token A token generated by CITCON
 */
+ (void)setupTokenKey:(NSString *_Nonnull)token;

/**
 * Setup the runtime mode for CITCON SDK.
 *
 * @param mode The mode of @CPayMode. Supports CPayModePROD,CPayModeUAT,CPayModeDEV
 */
 ...
 * @param application  An instance of UIApplication passed by AppDelegate
 * @param url An instance of NSURL passed by AppDelegate
 * @param callback Called after processed.
 */
 ...
 * @param vendor                  vendor
 * @param completion         completion callback, check the 'CPayCheckResultBlock' for details
 * @param acceleration    YES is to speed up CNY
 */
